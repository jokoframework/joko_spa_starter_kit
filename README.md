...
Cuenta con funcionalidades y código boilerplate ya fuera de la caja.

Como segundo objetivo este proyecto tiene la intención de ser opinionado en cuanto a estructuración y nombramiento de archivos para un proyecto JavaScript,
y también sobre nomenclaturas y patrones de código que se deben seguir.
...
¦   +-- /js/                    # Código Marionette/Backbone de la aplicación
	...
	¦   +-- /routers/           # AppRouter de Marionette con las rutas de la aplicación
	...
	¦   +-- main.js             # Punto de entrada de nuestra aplicación, acá empieza todo :)
¦   +-- /styles/                # CSS de la aplicación
¦   +-- /vendor/                # JS y CSS de terceros que queremos congelar para esta aplicación
¦   +-- index.html              # La página HTML que carga la aplicación que construimos en js/
...
Clone en su máquina la última versión de JSK (Joko Starter Kit):
...
Este comando va a construir la aplicación, copiando los archivos de código fuente (`/src`)
al directorio `/public` de salida. Tan pronto como esta construcción finalice va a lanzar
...
* Documentación con recetas para agregar nuevas vistas de Backbone
